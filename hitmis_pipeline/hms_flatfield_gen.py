...
def get_imgs_from_files(flist, wl, align_file: str):
...
for key in main_flist.keys():
    ...
    for w in wls:
        ...
        imgdata, expdata, tdata = get_imgs_from_files(filelist, w, align_file)
        ...
        ds = xr.Dataset(
            data_vars=dict(
                imgs=(['tstamp', 'height', 'wl'], imgdata[:,:,::-1], {'units': 'counts/s'}),
